const Part = {
  ...
  p_hornB: { root: 'p_head', link: 'brow', res: 'p_hd', regex: /horn.*_1$/ },
  p_ear: { root: 'p_head', link: 'brow', res: 'p_hd', regex: /ear.*_0$/ },
  p_earB: { root: 'p_head', link: 'brow', res: 'p_hd', regex: /ear.*_1$/ },
  p_face: { root: 'p_head', link: 'brow', res: 'p_fc', regex: /.*/ },
  p_faceX: { root: 'p_head', link: 'brow', res: 'p_fa', regex: /^((?!.*(_01)).)*$/ },
  p_faceXB: { root: 'p_head', link: 'brow', res: 'p_fa', regex: /.*_01$/ },
